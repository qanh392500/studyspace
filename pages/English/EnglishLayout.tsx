...
import { BookA, ChevronLeft, Menu } from 'lucide-react';
    ...
    <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      >
        <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between flex-shrink-0 h-[60px]">
            <h2 className="font-bold text-slate-700 dark:text-slate-200">English Menu</h2>
            <button 
        ...
        <div className="flex-1 overflow-y-auto py-4">
          ...
          >
            <BookA size={20} />
            <span>Học từ vựng (Flashcard)</span>
          </NavLink>
        </div>
      </aside>
      ...
      <main className="flex-1 relative flex flex-col overflow-hidden">
        ...
        {/* Reuse Gemini Widget or Create a specific English one later */}
        <GeminiTutor />
      </main>
    </div>
  );
